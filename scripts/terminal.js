$(function() {
  ...
  var commands = ["ls            show files available for download",
    ...
    'send_email    email me',
    'show_proj     show available projects',
    'open          open the project passed as argument',
  ...
  $('#terminal').terminal({
    ...
    open: function(proj) {
      if (proj == 'clickeat')
        window.open("/clickeat.html");
      if (proj == 'focusit')
        window.open("/focusit.html");
    },
    ...
    download: function(filename) {
      ...
      if (files.indexOf(filename) != -1) {
        ...
        } else if (filename == 'clickeat_master.zip') {
          window.open("https://github.com/lucaam/Click_Eat_Project/archive/master.zip");
          done = 1;
        } else if (done != 1) {
